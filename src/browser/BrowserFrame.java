 ...
 * integrated functionality to handle CirclePack 
 * XMD scripts *.cps (and *.xmd and *.cmd) and 
 * also *.p and *.q packing data files.
 * Recently Ken tried shifting to JavaFX web browser,
 * but ran into problems, mainly with catching 
 * clicks on links. Doing that work I made changes
 * in BrowserUtilities that need to be incorporated.
 * 
 * @author Alex Fawkes
 * @author kens, 
 */
