...
//		DCELdebug.printBouquet(pdcel);
		...
		while (generation < N) {
			...
			pdcel=CombDCEL.adjoin(pdcel,tempReverse.packDCEL,2,2,endcount);
			...
			pdcel=CombDCEL.adjoin(pdcel,tempReverse.packDCEL,2,3,hypcount);
			growWheel.vertexMap=pdcel.oldNew;
			...
			pdcel = CombDCEL.adjoin(pdcel,tempPack.packDCEL,2,3,longcount);
			growWheel.vertexMap=pdcel.oldNew;
			...
			pdcel=CombDCEL.adjoin(pdcel,tempPack.packDCEL,X,3,longcount);
			growWheel.vertexMap=pdcel.oldNew;
			updateLists(growWheel,tempPack.vlist,tempPack.elist,growWheel.vertexMap);
