 ...
 * Its 'FDomFace' is on its left. If face==null,
 * then this FDomHalfEdge and its twin are bdry FDomHalfEdges.
 * @author kstephe2, 8/2019
 */
public class FDomHalfEdge {

	public FDomVertex origin;
	public FDomHalfEdge twin;
	public FDomFace face;
	public FDomHalfEdge next;
	public FDomHalfEdge prev;
	public int edgeIndx;
	...
	public FDomHalfEdge(FDomVertex v) {
		this();
		origin=v;
	}
	 ...
	 * @return Vertex[2]
	 */
	public FDomVertex []detach() {
		FDomVertex []maroon=new FDomVertex[2];
	 ...
	 * @return new HalfEdge
	 */
	public FDomHalfEdge clone() {
		FDomHalfEdge he=new FDomHalfEdge();
		he.face=face;
		he.next=next;
		he.prev=prev;
		he.twin=twin;
